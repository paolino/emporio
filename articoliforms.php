    <td class=magazzino>
      ...
      <input type=hidden name="sql" value="nuovo_articolo"> 
		...
		'<?php echo $_SESSION['articolo'] ?>' size=20></td></tr>
          <tr><td class=magazzino> valore </td><td class=magazzino>
            <input class=text type=text name="valore"  size=20></td></tr>
          <tr><td class=magazzino></td><td class=magazzino>
            <button class=magazzino type="submit" value="Definizione articolo">
            Nuovo o cambia</button>
            </td></tr>
        </table>
      </form>
    </td>
   ...
   <td class=magazzino>
      ...
      <input type=hidden name="sql" value="eliminazione_articolo"> 
		...
		'<?php echo $_SESSION['articolo'] ?>' size=20></td></tr>
          <tr><td class=magazzino></td><td class=magazzino>
            <button class=magazzino type="submit" value="Eliminazione articolo">
